...
class TabuleiroView(context: Context, attributeSet: AttributeSet) : View(context, attributeSet) {
    ...
    var onCellTouched: ((Int, Int) -> Unit)? = null
    ...
    private fun handleTouchEvent(x: Float, y: Float) {
        val touchedRow = (y / cellSizePixels).toInt()
        val touchedCol = (x / cellSizePixels).toInt()

        onCellTouched?.invoke(touchedRow, touchedCol)
    }
